    ...
    private static RoomDatabase.Callback sRoomDatabaseCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                dao.deleteAll();
                Meal bread_small = new Meal("Bread, small, 20g", 10, "");
                dao.insert(bread_small);
                Meal bread_regular = new Meal ("Bread, regular 30g", 15, "");
                dao.insert(bread_regular);
                Meal bread_roll_small = new Meal ("Bread roll, small 40g", 20, "");
                dao.insert(bread_roll_small);
                Meal bread_roll_regular = new Meal ("Bread roll, regular 60g", 30, "");
                dao.insert(bread_roll_regular);
                Meal baguette = new Meal ("Baguette 10cm, 60g", 30, "");
                dao.insert(baguette);
                Meal cracker = new Meal ("Cracker", 5, "");
                dao.insert(cracker);
                Meal ricecake = new Meal ("Ricecake", 5, "");
                dao.insert(ricecake);
                Meal crisp_bread = new Meal ("Crisp bread, regular 15g", 10, "");
                dao.insert(crisp_bread);
                Meal sour_crisp_bread = new Meal("Sour crisp bread", 5, "");
                dao.insert(sour_crisp_bread);
                Meal karelian_pasty_regular = new Meal ("Karelian pasty, regular 70g", 25, "");
                dao.insert(karelian_pasty_regular);
                Meal karelian_pasty_small = new Meal ("Karelian pasty, small 30g", 10, "");
                dao.insert(karelian_pasty_small);
                Meal porridge_water = new Meal ("Porridge, 2dl made in water", 20, "");
                dao.insert(porridge_water);
                Meal porridge_milk = new Meal("Porridge, 2dl made in milk", 30, "");
                dao.insert(porridge_milk);
                Meal cereal = new Meal ("Cereal, 3dl", 30, "");
                dao.insert(cereal);
                Meal croissant = new Meal ("Croissant, 50g", 20, "");
